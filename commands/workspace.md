...
1. Use session-injected preferences, or read global then repo preferences when present (`~/.nexus/user/preferences.md`, then `.nexus/user/preferences.md`; repo overrides global) for `default workspace`.
